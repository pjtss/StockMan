...
const defaultsByModule: Record<FeatureModuleKey, CommonModuleSettings> = {
  ...
  "us-bollinger-band": { enabled: true, startTime: "00:00", endTime: "23:59", cooldownSeconds: 60, intervalSeconds: 600, activeDays: [1, 2, 3, 4, 5], featureSettings: { bollingerPolicy: { period: 20, stdDevMultiplier: 2, minPrice: 0, minVolume: 0, minTurnoverRatio: 0, zone: "LOWER_OR_BELOW", requireObvAdlSignal: true, obvSignalPeriod: 9, adlSignalPeriod: 9 } } },
