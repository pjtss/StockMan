...
const defaultsByModule: Record<FeatureModuleKey, CommonModuleSettings> = {
  ...
  "kr-daily-cache": { enabled: true, startTime: "08:00", endTime: "15:30", cooldownSeconds: 60, intervalSeconds: 3_600, activeDays: [1, 2, 3, 4, 5] },
  ...
  "us-daily-cache": { enabled: true, startTime: "00:00", endTime: "23:59", cooldownSeconds: 60, intervalSeconds: 3_600, activeDays: [1, 2, 3, 4, 5] },
