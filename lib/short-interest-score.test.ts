...
describe("short interest score", () => {
  ...
  it("scores supplied pressure metrics", () => expect(scoreShortInterest({ ticker: "AAPL", shortVolume: 60, totalVolume: 100, shortVolumeRatio: 60, shortInterest: null, daysToCover: 6, asOf: "2026-07-30", source: "FINRA", status: "OK" }).level).toBe("HIGH"));
});
