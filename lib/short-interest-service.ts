...
export async function fetchFreeShortInterest(rawTicker: string): Promise<ShortInterestMetric> {
  ...
  try {
    ...
    if (cached) return { ticker, shortVolume: cached.shortVolume, totalVolume: cached.totalVolume, shortVolumeRatio: cached.shortVolumeRatio == null ? null : cached.shortVolumeRatio > 1 ? cached.shortVolumeRatio / 100 : cached.shortVolumeRatio, shortInterest: cached.shortInterest, daysToCover: cached.daysToCover, previousShortInterest: cached.previousShortInterest, shortInterestChange: cached.shortInterestChange, shortInterestChangePercent: cached.shortInterestChangePercent, averageDailyVolume: cached.averageDailyVolume, thresholdListed: cached.thresholdListed, thresholdAsOf: cached.thresholdAsOf, asOf: cached.asOf, shortVolumeAsOf: cached.shortVolumeAsOf, shortInterestAsOf: cached.shortInterestAsOf, source: "FINRA", status: cached.status as ShortInterestMetric["status"] };
