...
export class IntradayMemoryState {
  ...
  recordRollingTurnover(market: string, code: string, sessionDate: string, bucketAt: number, tradingValue: number, marketCap: number, windowMs = INTRADAY_MVP_POLICY.windowMs, threshold = INTRADAY_MVP_POLICY.threshold) {
