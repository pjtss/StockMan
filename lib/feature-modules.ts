...
export const FEATURE_MODULES: FeatureModuleDefinition[] = [
  ...
  { key: "market-rss", label: "시장 RSS 통합", description: "SEC·StockTitan·시장 RSS 수집·번역·알림", settingsPath: "/admin/observability" },
  ...
  { key: "us-obv", label: "OBV 자동화", description: "미국 OBV 후보 탐지·알림", settingsPath: "/admin/observability" },
  { key: "us-daily-cache", label: "일봉 캐시 갱신", description: "미국 일봉 데이터 DB 갱신", settingsPath: "/admin/observability" },
  { key: "us-daily-breakout", label: "일봉 돌파 자동화", description: "최근 고가 돌파 후보 탐지·알림", settingsPath: "/admin/observability" },
  { key: "us-trade-intensity", label: "체결강도 자동화", description: "해외 체결강도 수집", settingsPath: "/admin/observability" },
  { key: "short-borrow", label: "대차 데이터 수집", description: "공매도 대차 데이터 수집", settingsPath: "/admin/observability" },
  { key: "discord-delivery-retry", label: "Discord 재전송", description: "실패한 Discord 알림 재전송", settingsPath: "/admin/observability" },
];
