...
export const FEATURE_MODULES: FeatureModuleDefinition[] = [
  ...
  { key: "kr-golden-cross", label: "국내 일봉 골든크로스", description: "국내 보통주의 일봉 9일 EMA가 20일 EMA를 상향 돌파하는 종목 탐지", settingsPath: "/admin/modules/kr-golden-cross", scheduler: "OCI_CRON" },
