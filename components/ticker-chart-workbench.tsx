      ...
      <section className={styles.panel}>
        ...
        <div className={styles.scanBox}>
          ...
          <div className={styles.scanFields}>
            ...
            <label><span>ADL Signal<HelpMark text="EMA(9) 기반 ADL Signal의 최근 방향입니다. 제한 없음을 선택하면 ADL 조건을 적용하지 않습니다." /></span><select value={adlTrend} onChange={e=>setAdlTrend(e.target.value as "ANY"|"RISING"|"FALLING")}><option value="ANY">선택 없음</option><option value="RISING">상승세</option><option value="FALLING">하락세</option></select></label>
