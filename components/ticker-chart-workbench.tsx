      ...
      <section className={styles.panel}>
        ...
        <div className={styles.scanBox}>
          ...
          <div className={styles.scanFields}>
            ...
            <label><span>OBV Signal<HelpMark text="EMA(9) 기반 OBV Signal의 최근 방향입니다. 제한 없음을 선택하면 OBV 조건을 적용하지 않습니다." /></span><select value={obvTrend} onChange={e=>setObvTrend(e.target.value as "ANY"|"RISING"|"FALLING")}><option value="ANY">선택 없음</option><option value="RISING">상승세</option><option value="FALLING">하락세</option></select></label>
            <label><span>골든크로스<HelpMark text="선택한 기준 봉에서 EMA(9)가 EMA(20)를 최근 상향 돌파한 종목입니다." /></span><select value={goldenCross} onChange={e=>setGoldenCross(e.target.value as "ANY"|"RECENT")}><option value="ANY">선택 없음</option><option value="RECENT">최근 상향 돌파</option></select></label><label><span>ADL Signal<HelpMark text="EMA(9) 기반 ADL Signal의 최근 방향입니다. 제한 없음을 선택하면 ADL 조건을 적용하지 않습니다." /></span><select value={adlTrend} onChange={e=>setAdlTrend(e.target.value as "ANY"|"RISING"|"FALLING")}><option value="ANY">선택 없음</option><option value="RISING">상승세</option><option value="FALLING">하락세</option></select></label>
