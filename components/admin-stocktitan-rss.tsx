...
type Article = Record<string, unknown> & { id: number; title: string; summary: string; rawPayload?: string | null; translatedTitle?: string | null; translatedSummary?: string | null; detectedTicker?: string | null; eventDirection?: string; financingAmountUsd?: number | null; dilutionRisk?: string | null; link: string; publishedAt?: string | null; category: string; priority: number; notifyEligible: boolean; isBacklog: boolean; translationStatus: string; translationFallback: boolean; translationError?: string | null; notificationStatus: string; lastError?: string | null };
