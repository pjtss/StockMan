...
type ModuleSettings = {
  ...
  featureSettings?: {
    ...
    evaluation?: { mfiThreshold?: number; obvSignalPeriod?: number; obvSignalAboveDays?: number; obvSignalCrossLookback?: number; trendMinScore?: number; trendMinRvol?: number; trendMinMfi?: number; trendMaxMfi?: number; trendRequirePriceTrend?: boolean };
...
const DEFAULT_SETTINGS: ModuleSettings = {
  ...
  featureSettings: {
    ...
    evaluation: { mfiThreshold: 30, obvSignalPeriod: 9, obvSignalAboveDays: 3, obvSignalCrossLookback: 5, trendMinScore: 70, trendMinRvol: 1.5, trendMinMfi: 50, trendMaxMfi: 85, trendRequirePriceTrend: true },
...
export function FeatureModuleOperations({ moduleKey }: { moduleKey: FeatureModuleKey }) {
  ...
  const updateTrendPolicy = (key: "trendMinScore" | "trendMinRvol" | "trendMinMfi" | "trendMaxMfi" | "trendRequirePriceTrend", value: number | boolean) => setSettings({ ...settings, featureSettings: { ...settings.featureSettings, evaluation: { ...settings.featureSettings?.evaluation, [key]: value } } });
