-- Reassert the activity flag after the common-stock universe split.
-- This is intentionally idempotent because older deployments may have
-- recorded V93/V100 while the split tables were recreated afterwards.
