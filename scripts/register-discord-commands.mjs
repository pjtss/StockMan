...
const response = await fetch(endpoint, { method: "PUT", headers: { authorization: `Bot ${botToken}`, "content-type": "application/json" }, body: JSON.stringify([{ name: "ticker", description: "미국 주식 티커 정보를 조회합니다.", type: 1, options: [{ name: "symbol", description: "예: AAPL", type: 3, required: true, max_length: 15 }] }]) });
