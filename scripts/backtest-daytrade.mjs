...
try {
  ...
  console.log(JSON.stringify({ market, lookbackDays: lookback, feeBps, cooldownDays, instrumentCount: grouped.size, sourceRows: rows.rowCount, tested: results.length, topByTotalReturn: results.slice(0, 10), topByWinRate: [...results].sort((a, b) => b.winRate - a.winRate).slice(0, 10) }, null, 2));
