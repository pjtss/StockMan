...
export async function GET(request: Request) {
  ...
  if (!Number.isFinite(staleAfterValue) || staleAfterValue < 60 || staleAfterValue > 86_400) return NextResponse.json({ ok: false, stage: "validate_filter", errorCode: "INVALID_STALE_THRESHOLD", staleAfterSeconds: params.get("staleAfterSeconds") }, { status: 400 });
